...
##### LOGO #####
logo = """
\033[1;93m       😎😎 GUNAKAN DENGAN BIJAK 😎😎   \033[1;31m
\033[1;95m«----🚫🚫🚫🚫\033[1;95mMENEMBUS BATAS 911🚫🚫🚫🚫\033[1;95m--------»
\033[1;96m             एक मुस्कान के साथ सभी                  \033[1;94m
\033[1;93m       ⚠️Create bye : OmDenay-MB911⚠️              \033[1;94m
\033[1;96m       الله يحفظنا دائما في السعادة             \033[1;94m
\033[1;92m       🌎WhatsApp  : 085930060122 🌎              \033[1;94m
\033[1;93m   ⚠️Youtube Channel: Menembus Batas 911⚠️         \033[1;94m
\033[1;95m«------------\033[1;95mMENEMBUS BATAS 911\033[1;95m--------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
...
def menu():
    ...
    time.sleep(0.05)
    print("\033[1;96m[3]  Install SpiderMan       Tool      🕸️")
    time.sleep(0.05)
    ...
    time.sleep(0.05)
    print("\033[1;96m[17] Install Termux Logo     Tool      ⚜️")
    time.sleep(0.05)
...
def mafia():
	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/OmDenay/hack911")
                print (logo)
	        ...
	        os.system("cd $HOME && git clone https://github.com/OmDenay-MB911/OmDenay-MB911/hack911")
                print (logo)
	        love("\033[1;93mTool User Name :\033[1;95m     Black ")
                love("\033[1;93mTool Password  :\033[1;95m     Mafia ")
	        ...
	        os.system("cd $HOME && git clone https://github.com/OmDenay-MB911/hack911")
                print (logo)
